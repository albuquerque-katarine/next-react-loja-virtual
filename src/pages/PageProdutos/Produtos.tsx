...
export default function Produtos() {
    ...
    return (
        <div className="page">
            <Header qtdProdutos={dados.length > 0 ? dados.length : 0} usuario={getLetraNome(router.query?.nome)} logado={getLogado(router.query.logado)} imagem={getLogado(router.query.logado) ? "../assets/loja_virtual_logo_topo.svg" : "./assets/loja_virtual_logo_topo.svg"} bgImagem={getLogado(router.query.logado) ? '../assets/loja_virtual_banner.svg' : './assets/loja_virtual_banner.svg'} />
            ...
            <Footer imagem={getLogado(router.query.logado) ? "../assets/loja_virtual_logo_footer.svg" : "./assets/loja_virtual_logo_footer.svg"} />
        </div>
    )
}
